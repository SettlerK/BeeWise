...
// ------------------------------------------------------------------- Wetter
  ...
  // ------------------------------------------------ Verlauf, Meldungen, Profil
  'Verstanden': 'Got it',
  'aus, weil im Betriebsprofil abgewählt': 'off, deselected in the operating profile',
  'Letzte Durchsicht: {d} · vor {n} Tagen': 'Last inspection: {d} · {n} days ago',
  'Verlauf einklappen': 'Collapse history',
  'Alle {n} Einträge anzeigen': 'Show all {n} entries',
  '{a} überfällig, {b} heute fällig': '{a} overdue, {b} due today',
  '{n} Aufgaben heute fällig': '{n} tasks due today',
  'und {n} weitere': 'and {n} more',
  'seit {n} Tagen': 'for {n} days',
  '{name} · {n} Aufgaben überfällig': '{name} · {n} tasks overdue',
  'Weiß ich nicht': 'Not sure',
  'Standort vom Gerät übernehmen': 'Use the device location',
  'Ohne Standort rechnet BeeWise mit festen Kalenderterminen statt mit der Wärmesumme am Ort – das ist deutlich ungenauer. Die Adresse kannst du später unter „Stand" nachtragen.':
    'Without a location BeeWise works from fixed calendar dates instead of local growing degree days, which is far less precise. You can add the address later under “Apiary”.',
  'Übernommen: {lat} / {lon}': 'Taken: {lat} / {lon}',
  'Frage {n} von {m}': 'Question {n} of {m}',
  'Weiter': 'Next',
  'Position wird bestimmt …': 'Getting your position …',
  'Position konnte nicht bestimmt werden.': 'Could not determine your position.',
  'Mein Bienenstand': 'My apiary',
  'Angelegt: {stand} mit {n} Völkern. Namen änderst du unter „Völker".':
    'Created: {stand} with {n} colonies. You can rename them under “Colonies”.',
  'Betriebsprofil gespeichert.': 'Operating profile saved.',
  'Noch offen': 'Not answered',
  '{a} von {b} beantwortet': '{a} of {b} answered',
  'Was hier steht, schaltet Aufgaben ein und aus. Unbeantwortet heißt: alles anzeigen.':
    'These answers switch tasks on and off. Unanswered means: show everything.',
  'Ändern': 'Change',

  'Waben je Zarge': 'Frames per box',
  'Ableger bilden': 'Make splits',
  'Honig abgeben': 'Pass honey on',
  'Betriebsprofil': 'Operating profile',
  'Ja': 'Yes',
  'Nein': 'No',
  'Fertig': 'Done',
  'Wo stehen deine Völker?': 'Where do your colonies stand?',
  'Wie viele Völker stehen dort?': 'How many colonies are there?',
  'Welche Beute, welches Maß?': 'Which hive, which frame size?',
  'Wie arbeitest du?': 'How do you work?',
  'Was ist dieses Jahr schon gelaufen?': 'What has already happened this year?',
  'Name des Bienenstands': 'Name of the apiary',
  'Überwinterte Wirtschaftsvölker': 'Overwintered production colonies',
  'Jungvölker und Ableger aus diesem Jahr': 'Nucs and splits from this year',
  'Schneidest du Drohnenbrut als Varroa-Maßnahme?':
    'Do you cut drone brood as a varroa measure?',
  'Willst du dieses Jahr Ableger bilden?': 'Do you want to make splits this year?',
  'Gibst du Honig ab – verkaufen oder verschenken?':
    'Do you pass honey on — selling or giving it away?',
  'Frühjahrsdurchsicht gemacht': 'Spring inspection done',
  'Frühtracht geerntet': 'Spring flow harvested',
